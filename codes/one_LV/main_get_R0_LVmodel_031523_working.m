...
gam_A = 1e-4;
% alph = 2e2;
% r_minus_gam_const = r_A - gam_fixed;
% slop = (1-alph)/gam_fixed;
% r_minus_gam_const = r_A - (1-alph);
...
gam_vals_range = 10.^linspace(-6,-1,200);
...
lysogen_equilibrium_fixed_nophage = (K*(r_A-d)/r_A);
...
% plot(gam_vals_range,r_corresponding_tradeoff,'k','linewidth',2);
plot(gam_A,r_A,'.','Color',[0.5 0.5 0.5],'MarkerSize',30);
set(gca,'YDir','normal');
cb1 = colorbar;
