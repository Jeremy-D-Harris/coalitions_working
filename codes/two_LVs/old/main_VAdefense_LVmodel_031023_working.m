...
VB_equilibrium_noLB = zeros(length(r_vals_range),length(gam_vals_range));
...
%         phage_equilibrium(count_r,count_gam) = this_phage_equilibrium;
        ...
        lysogen_equilibrium_withVB(count_r,count_gam) = this_lysogen_equilibrium;
        
        this_VB_equilibrium_noLB = ;
        VB_equilibrium_noLB(count_r,count_gam) = this_VB_equilibrium_noLB;
        
        this_phage_equilibrium_withVB = bet*this_gam*this_lysogen_equilibrium/(phi*this_lysogen_equilibrium+m);
        phage_equilibrium_withVB(count_r,count_gam) = this_phage_equilibrium;
