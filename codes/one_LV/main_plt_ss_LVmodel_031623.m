...
r_A_corresponding =results.r_A_corresponding;
...
plot(gam_vals_range,r_A_corresponding,'k','linewidth',5); hold on;
...
plot(gam_vals_range,r_A_corresponding,'k','linewidth',5);
plot(gam_A,r_A,'k.','MarkerSize',50);
set(gca,'YDir','normal');
cb1 = colorbar;
xlim([1e-6 1e-1]);
