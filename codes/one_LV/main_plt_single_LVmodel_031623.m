...
h(1)=loglog(x_values,Lysogen_equilibrium_nonzero_vector,'--','Color',my_rgb_colors(2,:),'linewidth',3); hold on;
h(2)=loglog(x_values,phage_nullcline,'--','Color',my_rgb_colors(1,:),'linewidth',3); hold on;
...
h(3)=loglog(init_conds_range(2,:),init_conds_range(1,:),'ko','MarkerSize',14,'linewidth',4); hold on;
h(4)=loglog(phage_equilibrium_nonzero,Lysogen_equilibrium_nonzero,'.','Color',[0.5,0.5,0.5],'MarkerSize',55); hold on;
