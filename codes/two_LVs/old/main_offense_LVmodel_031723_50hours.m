...
% lg(3) = semilogy(t_span,LB_traj(),'Color',[0.7 0.7 0.7],'linewidth',4); hold on;
lg(4) = semilogy(t_span,VB_traj,'--','Color',[0.7 0.7 0.7],'linewidth',4); hold on;
...
% % semilogy(time_pt*ones(1,10),linspace(0,1.1,10),'k--','linewidth',2); hold on;
