...
% plot(gam_fixed,r_fixed,'.','Color',[0 0 0],'MarkerSize',45);
...
% % subplot(1,2,2);
% lg(1) = semilogy(t_span,LA_traj(2,:),'k','linewidth',4); hold on;
% lg(2) = semilogy(t_span,VA_traj(2,:),'k--','linewidth',4); hold on;
% lg(3) = semilogy(t_span,VB_traj(2,:),'--','Color',my_rgb_colors(1,:),'linewidth',4); hold on;
% lg(4) = semilogy(t_span,LB_traj(1,:),'Color',my_rgb_colors(1,:),'linewidth',4); hold on;
